...
class Property extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, title, icon', 'safe', 'on' => 'search'),
            array('id, title, icon', 'safe'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'cars' => array(self::MANY_MANY, 'Car', 'car_property(property_id, car_id)'),
        );
    }
    ...
    public function behaviors() {
        return array(
            'EasyMultiLanguage' => array(
                ...
                'admin_routes' => array('admin/property/view', 'admin/property/update'),
