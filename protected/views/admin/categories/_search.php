<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="control-group adv-search">
			<input id="Categories_search_value" class="span5" type="text" name="Categories[search_value]" maxlength="100">

			<select id="Categories_search_key" class="span5" name="Categories[search_key]">
