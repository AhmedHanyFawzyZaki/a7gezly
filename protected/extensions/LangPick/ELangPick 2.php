            ...
            switch ($this->pickerType)
            {
                ...
                case 'links':
                    ...
                    foreach ($translations as $trans)
                    {
                     ...
                     echo CHtml::link($temp, Yii::app()->homeUrl,
                   	 array('class'=>(Yii::app()->getLanguage() == $trans ? 'active' : 'inactive'), 'submit'=>'',
                   	 'params'=>array('languagePicker'=>$trans))) . ($trans === end($translations) ? '' : $this->linksSeparator);
                    	$i++;
