...
<div class="control-group ">
    <label class="control-label" for="Pages_intro">Country</label>
    <div class="controls">
        <?php echo $form->dropDownList($model, 'country_id', CHtml::listData(Country::model()->findAll(), 'id', 'title'),array( 'prompt' => 'Select Country')); ?>	
    ...
    <div class='controls'>
        ...
        if ($model->isNewRecord != '1' and $model->image != '') {
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <?php
                    echo "<p id='image-cont'>" . Chtml::image(Yii::app()->baseUrl . '/media/locations/' . $model->image, '', array('width' => 200)) . "</p>";
                    echo CHtml::ajaxLink(
                            'Delete Image', array('/admin/location/deleteimage/id/' . $model->id), array(
