...
class Settings extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('facebook,youtube, google, twitter, pinterest, email, press_email, support_email, blog_email, paypal_email, api_username, api_password, signature, paypal_fee, paypalextra_fee, site_commession, phone, mobile, fax, address', 'length', 'max'=>255),
