    ...
    <div class='controls'>
        ...
        if ($model->isNewRecord != '1' and $model->image != '') {
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <?php
                    echo "<p id='image-cont'>" . Chtml::image(Yii::app()->baseUrl . '/media/homeSlider/' . $model->image, '', array('width' => 200)) . "</p>";
                    echo CHtml::ajaxLink(
                            'Delete Image', array('/admin/homeSlider/deleteimage/id/' . $model->id), array(
