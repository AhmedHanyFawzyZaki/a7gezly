      ...
      <div class="nav-collapse collapse navbar-responsive-collapse">
        <ul class="nav pull-right top-nav">
          ...
          <a data-toggle="dropdown" class="dropdown-toggle dropdown-avatar" href="#">
             <i class="icon-user icon-white"></i>&nbsp;<?= Yii::app()->user->username?> <b class="caret"></b>
          </a>
            <ul class="dropdown-menu ">
              <!-- the first element is the one with the big avatar, add a with-image class to it -->
              <!-- <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/user"><i class="icon-user"></i><span><?= Yii::app()->user->username?></span></a></li>
              <li class="divider"></li> -->
