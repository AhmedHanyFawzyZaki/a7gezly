    ...
    <div class="containerfull">
        <div class="row-fluid">
            ...
            <div class="span10 content top10px">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <ol class="breadcrumb rtl">
                            ...
                            <li class="active"> <?= Helper::t('عروض وتخفيضات') ?> </li>
                        </ol>
                        <div class="divid"></div>
                    </div>
                </div>
                ...
                <!--                <div class="ads-cats">
                                    <img src="<?php //echo Yii::app()->request->baseUrl;      ?>/media/categories/<?php //echo $getCatInfo->image;      ?>" class="img-responsive">
                                </div>-->
                    ...
                    <div class="cats-search">
                        ...
                        <div  class="tab-pane active" id="tab7" >
                            <div class="row-fluid grid">
                                <?php
                                //print_r($tripOffers);die;
                                foreach ($tripOffers as $trip) {
                                    ?>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12 slide-photo"> 
                                                ...
                                                if (!empty(Helper::getphoto($trip->gallery_id)->rank)) {
                                                    ...
                                                    ?>
                                                    <img src=" <?php echo Yii::app()->request->baseUrl; ?>/gallery/_<?php echo Helper::getphoto($trip->gallery_id)->rank; ?>.jpg" alt="Image"/> 
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    <div class="span6">
                                        <div class="well-sm list-cats-item">
                                            ...
                                            <div class="row-fluid bottom10px">
                                                ...
                                                <div class="span5 thumb relative">
                                                    ...
                                                    if (!empty(Helper::getphoto($trip->gallery_id)->rank)) {
                                                        ...
                                                        ?>
                                                        <a href="<?php echo Yii::app()->request->baseUrl . '/trip-' . $trip->url; ?>">
                                                            <img style="width:200px;height:150px" src=" <?php echo Yii::app()->request->baseUrl; ?>/gallery/_<?php echo Helper::getphoto($trip->gallery_id)->rank; ?>.jpg" alt="Image"/> 
                                                            <div class="circle-more cats-price list-cats-price">
                                                                <p><?= Helper::t('شوف التفاصيل') ?> </p>
                                                            </div>
                                            ...
                                            <div class="row-fluid list-item-footer">
                                                ...
                                                <div class="span4 tripadvisor"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/TripAdvisor-logo.png"></div>
                                            </div>
