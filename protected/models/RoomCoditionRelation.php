...
/**
 * This is the model class for table "room_codition_relation".
 *
 * The followings are the available columns in table 'room_codition_relation':
 * @property integer $id
 ...
 */
class RoomCoditionRelation extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('room_type_id, condition_id', 'numerical', 'integerOnly'=>true),
			array('temp1, temp2', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, room_type_id, condition_id, temp1, temp2', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return RoomCoditionRelation the static model class
	 */
