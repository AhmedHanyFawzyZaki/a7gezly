                ...
                <div class="row-fluid">
                    <div class="span12">
                        <ol class="breadcrumb rtl">
                            ...
                            <li class="active"><?= Helper::t('نتائج البحث') ?> </li> 
                        </ol>
                        <div class="divid"></div>
                    </div>
                </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12 slide-photo"> 
                                                ...
                                                if (!empty(Helper::getphoto($trip->gallery_id)->rank)) {
                                                    ?>
                                                    <img   style="height:150px" src="<?php echo Yii::app()->request->baseUrl; ?>/gallery/_<?php echo Helper::getphoto($trip->gallery_id)->rank; ?>.jpg" alt="<?php echo $trip->title ?>"/> 
                                                    <?php
                                                } else {
                                                    ?>
                                                    <img src=" <?php echo Yii::app()->request->baseUrl; ?>/media/default.jpg" alt="<?php echo $trip->title ?>"/> 
                                                    <?php
                                                }
                                                ?>
